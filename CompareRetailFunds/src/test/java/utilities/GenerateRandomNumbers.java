...
public class GenerateRandomNumbers {
	...
	//this function generates unique random numbers between 2 and 12 as per the product type 
	//table funds are listed from 2 to 12 table rows starting with zero
	//function returns a set of integers
