...
public class FundsCompare {
	...
	public void selectFourFundsFromList() {
		...
		//generate unique random numbers to select 4 funds
	...
	//this is the second approach to perform all step activities in the Page Object class so that step definition file looks clean
	public void PerformScenarioStep() throws InterruptedException {
		...
		//looping through each add funds button click sequence
		for(int item : pickedNums)
		{
			...
			index++;
			//pausing the thread as my PC is slow and sometimes generates exceptions
			Thread.sleep(3000);
		}
